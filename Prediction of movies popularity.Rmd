...
#Load the data
```{r}
mydata <- load("C:/Users/Aditya/Downloads/movies.Rdata")
```
...
```{r}
t2testmovies <- hotelling.test(imdb_rating+title_type+genre+runtime+imdb_num_votes+critics_rating+audience_rating+best_pic_win+best_actor_win+best_actress_win+best_dir_win ~ audience_score, data=mydata)
```
